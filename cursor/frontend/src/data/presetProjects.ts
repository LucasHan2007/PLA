import { LUNG_LESION_SEGMENTATION_PROJECT, LUNG_LESION_PROJECT_ID } from './lungLesionSegmentationProject'
...
export const PRESET_PROJECTS: PresetProject[] = [
  MNIST_DIGIT_PROJECT,
  LUNG_LESION_SEGMENTATION_PROJECT,
]
...
export { MNIST_PROJECT_ID, LUNG_LESION_PROJECT_ID }
